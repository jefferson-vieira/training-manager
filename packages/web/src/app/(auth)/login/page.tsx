    ...
    <main className="flex min-h-screen flex-col bg-[url(/login-bg.png)] bg-cover bg-center">
      ...
      <div className="mt-auto flex flex-col items-center gap-15 rounded-t-2xl bg-primary px-4 pt-12 pb-10">
        <div className="flex flex-col items-center gap-6">
          <h1 className="text-center font-heading text-[2rem] leading-[1.05] font-semibold text-primary-foreground">
        ...
        <p className="inline-flex items-center gap-1 font-heading text-xs text-primary-foreground">
