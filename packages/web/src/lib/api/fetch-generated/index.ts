...
export type getHomeDataResponseError = {
  headers: Headers;
} & (getHomeDataResponse401 | getHomeDataResponse404 | getHomeDataResponse500);

export type getHomeDataResponseSuccess = {
  headers: Headers;
} & getHomeDataResponse200;
...
export type getUserResponseError = {
  headers: Headers;
} & (getUserResponse401 | getUserResponse404 | getUserResponse500);
...
export type getApiStatsResponseError = {
  headers: Headers;
} & (getApiStatsResponse401 | getApiStatsResponse404 | getApiStatsResponse500);

export type getApiStatsResponseSuccess = {
  headers: Headers;
} & getApiStatsResponse200;
...
export type getWorkoutPlansResponseError = {
  headers: Headers;
} & (getWorkoutPlansResponse401 | getWorkoutPlansResponse500);

export type getWorkoutPlansResponseSuccess = {
  headers: Headers;
} & getWorkoutPlansResponse200;
...
export type createWorkoutPlanResponseSuccess = {
  headers: Headers;
} & createWorkoutPlanResponse201;
...
export type getWorkoutPlanResponseSuccess = {
  headers: Headers;
} & getWorkoutPlanResponse200;
...
export type getWorkoutDayResponseSuccess = {
  headers: Headers;
} & getWorkoutDayResponse200;
